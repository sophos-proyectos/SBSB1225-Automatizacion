...
import static com.sophos.app.ui.GeneralObjectsPage.ALLOW_LOCATION_PERMISSIONS_IOS;
...
public class AddPermissionsOfUbication implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        if (Boolean.FALSE.equals(Properties.getPlatformName().equalsIgnoreCase(com.sophos.app.enums.Properties.PLATFORM_NAME.value()))
